...
class MarketStructure:
    ...
    # ── Momentum signals ──────────────────────────────────────────────
    def _compute_momentum(self, close: float) -> None:
        """
        Long:  LH → HH sequence in swing highs  +  active bull CHoCH
        Short: HL → LL sequence in swing lows   +  active bear CHoCH
        ...
        self.momentum_long  = seq_lh_hh and choch_bull
        self.momentum_short = seq_hl_ll  and choch_bear
